 ...
 */
@WebServlet(name = "AfterLoginThueXe", urlPatterns = {"/afterLoginThueXe"})
public class AfterLoginThueXe extends HttpServlet {
...
//                    request.getRequestDispatcher("xacnhan").forward(request, response);
