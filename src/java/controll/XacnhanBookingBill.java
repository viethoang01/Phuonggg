...
//            response.getWriter().print(bill.getAccId());
            ...
            dao.InsertBooking(bill.getAccId(), bill.getNameCustomer(), bill.getPhone(), bill.getEmail(), bill.getCarName(), bill.getKm(), bill.getBienso(), bill.getDichvu(), bill.getNgay(), bill.getGio());
